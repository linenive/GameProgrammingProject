...
public:
	...
	void SetBlock(int _layer_index, string _name, StaticUnit* _owner) {
		Block& target_block = *layer[_layer_index];
		target_block.SetName(_name);
		target_block.owner = _owner;
		target_block.is_exist = true;
	}
